...
def handle(msg):
    ...
    if msg.body.type == 'init':
        ...
        if msg.body.type == 'read':
        ...
        elif (msg.body.type == "read_server_ok" or msg.body.type == "error_read") and msg.src in currentReadQuorum:
            value = (msg.body.value.value,msg.body.value.timestamp) if msg.body.type != "error_read" else (None,-1)
            ...
            if msg.body.type == 'lock_ok':
                queue_locks_write.append((msg.body.value.value,msg.body.value.timestamp,msg.src))
            ...
            for node in currentCasQuorum:
                send(src=node_id, dest=node, type="cas_lock", key = msg.body.key, 
                **{"from": getattr(msg.body,"from")},to = msg.body.to)
